...
const samples = [
  ...
  },
  {
    ...
    body: {
      ...
      savedCount: 1,
      needsSourceCheck: 0,
      matchingProgramIds: ['mlh-open-source-fellowship'],
      alertReadyProgramIds: ['mlh-open-source-fellowship'],
      savedProgramIds: ['mlh-open-source-fellowship'],
      watchedProgramIds: ['mlh-open-source-fellowship'],
      watchedPrograms: [
        {
